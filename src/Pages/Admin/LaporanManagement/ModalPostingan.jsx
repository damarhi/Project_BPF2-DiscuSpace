...
export default function ModalPostingan({ open, onClose, id_postingan, judul_postingan }) {
        ...
        const fetchLaporan = async () => {
            ...
            try {
                ...
                const filtered = laporanData
                    .filter((lap) => lap.id_postingan === id_postingan)
                    .map((lap) => ({
                        ...lap,
        ...
        <dialog open className="modal">
            <div className="modal-box max-w-3xl">
                ...
                <h3 className="font-bold text-lg mb-1">
                    Laporan terhadap postingan:{" "}
                    <span className="text-blue-600">{judul_postingan}</span>
                </h3>

                {laporanList.length === 0 ? (
                    <p className="text-sm text-gray-500 mt-4">
                        Tidak ada laporan terhadap postingan ini.
                    </p>
                ) : (
                    <Pagination
                        data={laporanList}
